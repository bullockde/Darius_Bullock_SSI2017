  ...
  wp_update_post( $my_post );
		...
		if($_GET['all']){
			...
			<div class='clear'></div>
				...
				<hr><h1>MasterSHE has <u><a href='/requests/'><?php echo count($all_requests);?></a></u> SUB Requests!</h1><hr>
			<div class='clear'></div>
...
$state = get_field( "MX_user_state", $request->ID );
	...
	<div class='col-sm-6'>
		...
		//	echo "Consent:" . get_field( "MX_user_consent", $request->ID ) . ' ... <br><br>';	
			...
			<div class='clear'></div>
		<div class='clear'></div><hr><center><span style='font-size: 16px;'>
