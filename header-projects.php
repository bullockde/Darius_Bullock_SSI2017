                    ...
                    <div class="col-sm-6 col-md-6">
									...
									<h2 class="entry-title ">
                                        ...
                                        $title_posted = false;
    										 ...
    										 if( get_the_title() ){ the_title(); }else{ echo "#SSIDashMaster"; }  ?>
    										
    									</a>
									</h2>
									<div class="clearfix"></div>
								</div>
								<div class="col-md-3 col-sm-6 hidden 1visible-xs 1visible-sm">
								    <div class="clearfix"></div>
									   <div class="clearfix mb-15 hidden-xs"></div>
										...
										<?php if( !is_user_logged_in() ){ ?>
										    ...
										    <a target="_blank" href="/register/" class="btn btn-info" title="Sign Up for FREE!"><b>Create</b> a <b>NEW Profile</b> &raquo; </a>
									    <?php }else{ ?>
