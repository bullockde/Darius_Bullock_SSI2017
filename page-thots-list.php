...
get_header('network'); ?>
			...
			$models = get_posts(array(  'post_type' => 'ssi_models' , 'posts_per_page' => -1 , 'orderby' => 'modified', 'order' => 'asc' , 'post_status' => 'publish' ));
			...
			$thots = get_posts(array(  'post_type' => array(/*'ssi_models', 'ssi_requests',*/ 'ssi_thots') , 'posts_per_page' => -1 , /*'orderby' => 'modified',*/ 'order' => 'desc' , 'post_status' => array('publish' /*, 'pending'*/ )  ));
...
<br>
		...
		<button id="models" class="btn rsvp ">> Get in Line <</button>
		</center>
		<br>
		...
		<div class=' video'>
				...
				$args = array( 'numberposts' => 1, 'post_type' => 'ssi_thots' , /*'orderby' => 'modified',*/ 'order' => 'desc' , 'post_status' => 'publish'  );
				...
				foreach( $recent_posts as $recent ){
					...
					//print_r($recent);
					?> 
					<h4>- OUR #<?php echo count($thots); ?> THOT -</h4>
		...
		<div class='well'>
			...
			<?php 
				...
				if( is_user_logged_in() ){
					?>
					<a href='/thots-home' class='btn btn-success btn-lg btn-block'>Enter Here >></a>
					<?php
				}else{
					?>
