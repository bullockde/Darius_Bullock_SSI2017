...
<div class='row '>
	...
	<div id='add-gallery' style='display: block;' class='text-center <?php if ( /*!is_user_logged_in()*/ 0  ) { echo "hidden"; } ?>'>
		...
		<div id='add-gallery' style='display: none; padding: 5px;'  class='row well yellow '>
			...
			<div class="1col-md-10 1col-md-offset-1 text-left">
			<div class="well">
...
?>
								<a href="/?p=<?php echo $lead->ID; ?>"> 
								    <?php echo get_the_post_thumbnail( $lead->ID , thumbnail-size , array( 'class' => 'img-thumbnail 1ads 1ad-shift 1circle' ) ); ?>
								</a>
								<?php
   					 	}
				...
				<div class="col-xs-8">
					...
					?>
					<a href='/?p=<?php echo $lead->ID; ?>'>
						<strong><?php /*echo $lead->post_title;*/ ?><?php if( strlen($post_title) >= 12 ){ echo substr( $lead->post_title ,0 , 12) . "..";   }else{ echo $lead->post_title; } ?></strong> | <small>
...
?>
		...
		<div class='col-md-4   text-center '>
	        ...
	        <div class='clearfix mb-15'></div>
	         ...
	         <div class='well  hidden text-center mb-15'>
		        <?php 
