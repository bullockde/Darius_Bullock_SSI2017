...
<div class="col-sm-7 col-sm-offset-1  ">
			...
			<h3><center><input type='text' name='post_title' placeholder='Username'></center></h3><hr>	
				<div class=' col-xs-6'>
				Age:
			</div>
			<div class=' col-xs-6'>
			...
			<input type='hidden' name='post_type' value='ssi_breed'>
				
			<input type='hidden' name='post_content' value='Added from Add Breeder!'>	
