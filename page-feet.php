...
get_header('members'); 
	...
	$photos = get_posts(array(  'post_type' => 'ssi_photos' , 'posts_per_page' => -1 ));
			...
			$thots = get_posts(array(  'post_type' => array(/*'ssi_models', 'ssi_requests', */'ssi_breed', 'ssi_thots') , 'posts_per_page' => -1 , 'orderby' => 'modified', 'order' => 'asc' , 'post_status' => array('publish'/*, 'pending'*/) /*, 'category_name' => 'North Philly Feet'*/ ));
...
<?php
	...
	<div class='clearfix'></div>
		...
		<div class=' video'>
				...
				$args = array( 'numberposts' => 1, 'post_type' => 'ssi_photos' , 'orderby' => 'modified', 'order' => 'desc' , 'post_status' => 'publish' , 'category_name' => 'North Philly Feet' );
