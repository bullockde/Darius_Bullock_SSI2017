		...
		<?php
			if( /*is_user_logged_in()*/ 1 ){ ?>
                ...
                <div class="profile-menu-top 1container-fluid text-center">
                    ...
                    <div class="col-sm-6 col-md-4 hidden1">
                                       <div class="clearfix mb-15 hidden-xs"></div>
                                       
									<h2 class="entry-title <?php if( is_user_logged_in() && wp_is_mobile() ){ echo '1hidden'; } ?>">
    									<a href="/members/">
    									<?php
            ...
            //                             $title_posted = false;
    										 ...
    										 if( is_front_page() || is_page('members-mobile') ){ echo "DLFreakFest.org"; $title_posted = true; }elseif( is_single() ){ echo $title; $title_posted = true; }elseif( get_the_title() ){ the_title(); }else{ echo "#SSIDashMaster"; }  ?>
	                                           ...
	                                           <center>
                                        		...
                                        		<form name="loginform" id="loginform" action="<?php echo site_url( '/wp-login.php' ); ?>" method="post">
                                        		 ...
                                        		 <?php
                                        				...
                                        				<h4><b><?php if( is_user_logged_in() ){  $current_user = wp_get_current_user(); echo 'Welcome Back, ' . strtoupper($current_user->user_nicename) . '!'; }else{ echo "<b>Welcome, " . $_COOKIE['name'] . "!</b>";}  ?></b>
                                        				<div class="clearfix mb-5"></div>
...
<div class="container-fluid text-center bg-blue header hidden1">
	...
	<div class="1container-fluid text-center bg-blue 1header mb-0 hidden">
	<div class="clearfix mb-0"></div>
	...
	<div class=" col-md-3 col-sm-3 col-xs-3 ">
		...
		<a href="/dashmaster" class="white">
			<span class="glyphicon glyphicon-transfer hidden" aria-hidden="true"></span>
			<br>
			DASH
		</a>
		<a type="button" class="white" id="myBtn2" data-toggle="modal" data-target="#myModal2-dash" data-show="true">
