...
<body <?php body_class(); ?>>
		...
		<header id="masthead" class="site-header" role="banner">
			...
			<center>
				...
				<h1 class="entry-title text-center"><?php the_title( '<h1 class="entry-title text-center">', '</h1>' ); ?></h1>
...
?>
        ...
        <div id='no-pic' class=" well alert-warning hidden">
