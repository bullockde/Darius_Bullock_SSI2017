...
<div id="" class=" text-center">
		...
		<div class="clearfix"></div>
			<div id='models' class=' well col-sm-6 col-sm-offset-3' style='display:block;'>
				<hr>
...
<?php endif; ?>
				...
				<a href="/photos" class="btn btn-default rsvp button hidden1" target="_blank">All Photos >></a>
