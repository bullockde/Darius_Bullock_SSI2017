...
<div class='col-md-8  text-centersingle <?php if( !is_user_logged_in() &&	(get_field( 'member_level', $post->ID ) != 'Public') ){ echo "not-logged"; }  ?>'>
		...
		<?php 
			if ( has_post_thumbnail( $post->ID ) ) {
				...
				<?php
					...
					?>
				<a href='/ssi_breed/<?php echo $post->post_name; ?>'> <img src='' class='img-responsive '> <?php echo get_avatar( $post->ID, "160"); ?></a>
				<?php
				}
