...
get_header('members'); 
	...
	$photos = get_posts(array(  'post_type' => 'ssi_photos' , 'posts_per_page' => -1 ));
			...
			$thots = get_posts(array(  'post_type' => array(/*'ssi_models',*/ 'ssi_thots', 'ssi_breed', 'ssi_contact') , 'posts_per_page' => -1 , 'orderby' => 'modified', 'order' => 'asc' , 'post_status' => array('publish'/*, 'pending'*/) /* , 'category_name' => 'pros' */));
...
<!--
		...
		-->
		<a href="/training" target="_blank" class="btn btn-success btn-block btn-lg hidden1 pulse mb-15"><br>START THoT TraininG &rarr;<br><br></a>
		...
		<div class='clearfix mb-10'></div>
				...
				<a href="/thot-request" target="_blank" class="btn btn-success1 btn-default btn-block btn-lg hidden1 pulse"><br>SUBMIT a THoT RequesT &rarr;<br><br></a>
...
<?php
	...
	<div class='well col-sm-6 text-center col-sm-offset-3'>
		...
		<div class=' video'>
			...
			<h4>We Currently Have: </h4><br>
								...
								<div class=" col-xs-4 text-center well green">
			...
			<a href="/videos">
			  <figcaption><h3><?php echo count($videos); ?></h3> <h4>VIDEOs</h4></figcaption>
									...
									<div class=" col-xs-12 text-center well hidden1 green">
		...
		<?php } ?>
			...
			<?php 
				...
				if( is_user_logged_in() ){
					?>
					<a href='/list' class='btn btn-success btn-lg btn-block pulse'><br>Enter Here >><br><br></a>
					<?php
				}else{
					?>
					<button id='login' class='btn btn-success btn-lg btn-block'>Login Here</button>
			<div id='login' style='display: none;'>
				<?php echo do_shortcode("[wpmem_form login redirect_to='/list']"); ?>
			</div>
					<?php
				}
			?>
	...
	<div class="login-form">
		<?php if( is_user_logged_in() ){ echo do_shortcode("[wpmem_form login redirect_to='/list']");  } ?>
	</div>
	</div>
