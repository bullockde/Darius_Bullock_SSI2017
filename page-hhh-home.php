...
<div id="" class=" text-center">
		...
		<br>
		<a href="/events" class="btn btn-default rsvp button" target="_blank">> Our VIP List <</a>
		<br><br>
	...
	?>
				...
				<?php $rsvps = get_field( 'event_rsvps' , $lead->ID); 
					...
					?>
					( <u><?php echo $seats; ?></u> Seats Left ) <br>
		...
		<div class='well'>
			...
			<?php 
				...
				if( is_user_logged_in() ){
					?>
					<a href='/movies-home' class='btn btn-success btn-lg btn-block'>Enter Here >></a>
					<?php
				}else{
					?>
