...
<?php	
	...
	<div class="col-sm-6 col-md-4 person text-center  mb-0">
	    

								<span class='hidden white 1h3 strong btn-lg btn btn-block1' style='float:none; background: red; padding: 2px  5px; color: white; '><small></small> <b>#<?php echo $count+$offset+1; ?></b></span>
								<div class='clearfix mb-10'></div>
					<div class=" well mb-0">			
