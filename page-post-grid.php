...
?>
 ...
 <?php
	...
	$no=4;// total no of author to display
...
<?php	
    ...
    if ( !empty( $all_photos ) ) {
        foreach ( $all_photos as $lead ) {
	      ...
	      //  get_template_part( 'content', 'post-1' ); 
	...
	<div class="hidden1 col-xs-6 col-md-4 person text-center well mb-10">
...
<div class="mini-left">
								...
								<?php
										...
										echo get_the_post_thumbnail($lead->ID, array(75, 75));
...
// Previous page
	...
	if(!get_previous_posts_link()) {
				...
				echo '<a class="btn btn-lg btn-primary" href="'. add_query_arg(array('paged' => $current_page-1)) .'">&laquo PREV</a>';
				echo "&nbsp;";
