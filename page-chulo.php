...
<div id="" class="">
	...
	<center>
		...
		<!--
		<iframe width="100%" height="315" src="https://www.youtube.com/embed/Zr1fz_5B4gQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		-->
		<iframe width="100%" height="315" src="https://www.youtube.com/embed/videoseries?list=PL6FhCd_HO_ADsLR9PTgwJvQysHc917ChU" allowfullscreen=""></iframe>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PL6FhCd_HO_AAvCKQVvLWsJ-FLW4oFIMUx" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<?php
	...
	<div class='clearfix'></div>
		...
		<div class=' video'>
			...
			<figure>
				<a href="/thot-list">
					<figcaption><h3><?php echo count($thots); ?></h3> <h4>Models</h4></figcaption>
				</a>
			</figure>
	...
	<div class="join">
		...
		<div id="menu" style='display: block;'>
			...
			<a href='/add' class='btn btn-block btn-info btn-lg hidden1'>Join Now</a>
