<?php
/**
 * Template Name: Playrooms Template
 *
...
<div id="" class=" text-center">
	...
	<header class="entry-header hidden1">
		Welcome to The World Famous
		
		<?php  the_title( '<h1 class="entry-title">', '</h1>' ); ?>
		
		<h3 class="entry-header hidden">- Hoody's PLAYROOM -</h3>
	</header><!-- .entry-header -->

<div class='clear'></div><hr>
		<center>
		<a href="/about" class="btn btn-default rsvp button" target="_blank"><< About</a>
		<a href="/events" class="btn btn-default rsvp button" target="_blank">Events >></a>
		<button id="models" class="btn rsvp hidden">> Our VIP List <</button>
		</center>
		<br>
		<a href="/vip" class="btn btn-default rsvp button" target="_blank">> Our VIP List <</a>
		<br><br>
		...
		<div class="stats">
			<hr><h4>Upcoming Events:</h4><hr>
		<?php
			$upcoming_events = get_posts( array (  
						
					   'posts_per_page'         =>  -1,
					   'post_type' => 'ssi_events',
					   'category_name' => 'playroom',
					   //'meta_key'               => 'event_date',
						'order' => 'desc', 
	...
	?>
				...
				<div class='clear'></div><hr>
				<div class='col-sm-8 col-sm-offset-2 hidden1 '>	
					<?php 
				...
				<!--<br>
				<h4>$<?php echo get_field( 'event_price' , $lead->ID); ?> online</h4>
			-->
		...
		<div class="col-xs-4 text-center well">		
			<figure>
			  <figcaption><h3><?php echo count($videos); ?></h3> <h4>Movies</h4></figcaption>
			</figure>				
		</div>
		...
		<div class=" col-md-4 col-xs-6 text-center well">				
			<figure>
		...
		<div class="col-xs-12 text-center well">
			...
			<a href="/thots" class="btn btn-default rsvp button" target="_blank">> The THOT List <</a>
