	...
	<div class="text-center  mb-0">
		<?php 
			if ( is_user_logged_in() ) {
				...
				?>
				<a class="white h3" href="/add">Join Now - 100% FREE!</a> 
				<?php
			}
		?>
...
<?php echo get_stylesheet_directory_uri(); ?>/images/icons/icon-<?php echo $site->post_name; ?>.png'  class=''>
 ...
 <a type="button" class="btn btn-default btn-sm hidden1" id="myBtn2" data-toggle="modal" data-target="#myModal2-social" data-show="true"><span class=" glyphicon glyphicon-plus" aria-hidden="true"></span> </a>
		...
		<div class='clearfix mb-0'></div>
								...
								<div class='clear'></div><hr><h3>Album Uploads -  <a type="button" class="btn btn-default 1btn-md hidden1" id="myBtn2" data-toggle="modal" data-target="#myModal2-albums" data-show="true"><span class=" glyphicon glyphicon-plus" aria-hidden="true"></span> Albums</a></h3><hr>
...
$count++;  ?>
								...
								<div class='clear'></div>
	 <a type="button" class="btn btn-default 1btn-md hidden1" id="myBtn2" data-toggle="modal" data-target="#myModal2-photos" data-show="true"><span class=" glyphicon glyphicon-plus" aria-hidden="true"></span> Photos</a>
    <a type="button" class="btn btn-default 1btn-md hidden1" id="myBtn2" data-toggle="modal" data-target="#myModal2-albums" data-show="true"><span class=" glyphicon glyphicon-plus" aria-hidden="true"></span> Albums</a>
...
<a target='_blank' href='/videos' class='btn btn-info btn-block hidden1'> All Videos >></a>
			<div class='clear'></div>
