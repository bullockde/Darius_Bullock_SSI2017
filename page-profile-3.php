 ...
 */
  ...
  if( $_POST['edit_profile'] ){
		...
		?>
		<br>
		<center><a href="/members" class="btn btn-success btn-lg text-center">View Members &rarr;</a></center>
		
		<br>
		<?php
		//wp_redirect( '/edit-profile/?ID=' . $current_user->ID );
		//exit;
	}
...
<div id="" class="">
	...
	<div class='clearfix'></div>
		...
		<h4> <?php echo 'Hello, ' . $current_user->display_name . '!'; ?> <br><br><small>&dArr;&nbsp; This is How You Will Appear Online &nbsp;&dArr;</small></h4>
...
<div class="col-sm-8 1col-sm-offset-1  ">
			...
			<div class=' col-xs-8'>
				 <input type='number' name='MX_user_age' placeholder='18' value='<?php echo get_user_meta(  $current_user->ID, 'MX_user_age', 1); ?>' class='form-control' required>
			</div>
			<div class='clear'></div><br>
			<div class=' col-xs-4'>
				Ht:
			...
			<?php 
				...
				?>
				<select name="MX_user_height_ft" class="form-control1">
				<?php 
				...
				?>
				<select name="MX_user_height_in" class="form-control1">
				<?php 
					foreach($options as $option){
			...
			<div class=' col-xs-8'>
				<input type='number' name='MX_user_weight' value='<?php echo get_user_meta($current_user->ID, 'MX_user_weight', 1); ?>' class='form-control1'>
			</div>	
		...
		<div class='col-sm-3'>
			...
			<b>Zip</b>
				...
				<input type='hidden' name='ssi_profile_complete' value='Yes'>
		</div> 
		<div class='clearfix'></div><hr>
				
		<input type='submit' value='My Profile is Complete &raquo;' class='btn btn-lg btn-success btn-block' style='padding: 2em 1em; font-size: 12px; '>
				...
				<a href='/members' class='btn btn-block btn-success btn-lg hidden'>My Profile is Complete &raquo;</a>
