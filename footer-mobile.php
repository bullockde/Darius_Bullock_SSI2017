...
<div class="clearfix mb-0"></div>
<?php }else{ ?>
     <div class='container-fluid clearfix 1col-md-2 hidden 1col-md-offset-5 p-0 footer-login well yellow mb-0 align-center'>
...
function updateTime(){
  $('#time').html(Date('Y-m-d H:i:s', strtotime(timestamp)));
  timestamp++;
}
$(function(){
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
      $(document).ready(function() {
        ...
        setInterval(function() {
          var now = new Date();
          var eastCoast = now.toLocaleString("en-US", {timeZone: "America/New_York"});
    ...
    var year = now.getFullYear();
          var timeString = eastCoast + '-' + day + ' ' + month + ' '+ dayNum + ', ' + year + ' ' + hours + ':' + minutes + ':' + seconds;
