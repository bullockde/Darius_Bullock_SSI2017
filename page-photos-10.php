...
<div class=' '>
	...
	<div id='add-gallery' style='display: block;' class='text-center <?php if ( /*!is_user_logged_in()*/ 0  ) { echo "hidden1"; } ?>'>
			
			<button id='add-gallery' class='hidden1-print btn btn-success btn-lg btn-block hidden11 pulse'><br><h3>> Add Photos <</h3><br></button>
		...
		<div id='add-gallery' style='display: none;'  class='well green'>
			...
			?></div>
			<div class='clear'></div>	
			<button id='add-gallery' class='hidden1-print btn btn-default btn-sm'>x close</button>
	...
	<div class='clearfix mb-10'></div>
			...
			<div class="paginator hidden1"><center>
                ...
                <a class='pull-left hidden1' href='/category/straight-porn'>&lsaquo; Str8</a>
				<a class='pull-right hidden1' href='/category/gay'>Gay >></a>
				</center>
            </div>
...
<?php
	...
	?>
		...
		<!-- 
    			...
    			$large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id( $lead->ID ), array(50,50) );	
   						...
   						if ( ! empty( $large_image_url[0] ) ) {
        					...
        					//	echo get_the_post_thumbnail( $lead->ID, 'thumbnail' ); 
        						echo '</a>';
?>
								<a href='/?p=<?php echo $lead->ID; ?>'> <img src='<?php echo esc_url( $large_image_url[0] ); ?>' class='1img-responsive img-thumbnail circle'></a>
								<?php
   					 	}
	...
	?>
				...
				<div class='clearfix '></div><hr class="mb-0">
					<a href="/?p=<?php echo $lead->ID; ?>" class="btn btn-block btn-default hidden11">View &raquo;</a>
			...
			<div class='col-md-4 hidden1'>
				...
				<p class="btn btn-block btn-lg hidden1" style="text-align: center;"><a href="/<?php echo $lead->post_type; ?>/<?php echo $lead->post_name; ?>">View Preview</a></p>
				<p class="btn btn-block btn-lg hidden1" style="text-align: center;"><a href="/subscribe/">Subscribe Now!</a></p>
			</div>
			<div class='clear'></div>
